...
import React, { useContext, useState } from 'react'; // 1. useState add kora hoyeche
import { FriendsListContext } from '../../../context/FriendsListContext';
import { toast } from "react-toastify";
import { FaTrashAlt, FaSearch } from 'react-icons/fa'; // FaSearch add kora hoyeche
import useFriendList from '../../../hooks/useFriendList';
import { HashLoader } from 'react-spinners';
...
const Timeline = () => {
  ...
  // timelineData-ke shorasori map na kore amra filteredData map korbo
